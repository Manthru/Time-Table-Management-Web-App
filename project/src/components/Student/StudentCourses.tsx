...
import { BookOpen, User, Award, Users, Clock, MapPin } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Semester {user?.semester} - {user?.department} Department
        </p>
      </div>
              ...
              <div className="p-6">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-600">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="font-medium text-gray-900 mr-1">Professor:</span>
                            <span>{course.professor}</span>
                          </div>
                          <div className="flex items-center">
                            <Users className="h-4 w-4 mr-2 text-gray-400" />
                            <span className="font-medium text-gray-900 mr-1">Enrolled:</span>
                ...
                {courseSchedule.length > 0 && (
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <h4 className="text-lg font-medium text-gray-900 mb-4">Class Schedule</h4>
      ...
      {studentCourses.length === 0 && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600">
            No courses are currently assigned to your department and semester.
          </p>
        </div>
      )}
    </div>
