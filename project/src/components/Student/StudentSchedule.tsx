...
export function StudentSchedule() {
  ...
  const getSlotForDayAndTime = (day: string, time: string) => {
    return studentTimeSlots.find(slot => {
  ...
  const getCourseForSlot = (slot: any) => {
    return studentCourses.find(course => course.id === slot.courseId);
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600">Your personalized class schedule</p>
        </div>
